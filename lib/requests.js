 ...
 */
function request(method, url, { cookie_key=undefined, content_type="application/x-www-form-urlencoded", timeout_ms=20*1000, allow_self_signed=false, ...extras}={}, body='') {
    ...
    if ( include_body ) {
        if ( typeof(body) !== "string" ) body = qs.stringify(body);
